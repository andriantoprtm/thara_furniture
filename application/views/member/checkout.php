...
<section class="cart bgwhite p-t-30 p-b-100">
            ...
            <div class="wrap-table-shopping-cart bgwhite">
                ...
                <table class="table-shopping-cart">
                    ...
                    foreach ($keranjang as $keranjang) {
                        ...
                        $kode_transaksi = date('dmY') . "$i";

                    ?>
                        <tr class="table-row">
                            <td class="column-1"><?= $kode_transaksi ?></td>
                            </td>
                            <td class="column-2">
                            ...
                            <td class="column-3"><?= $keranjang['name'] ?></td>
                            <td class="column-4">Rp. <?= number_format($keranjang['price'], '0', ',', '.') ?></td>
                            <td class="column-5">
    ...
    <div class="col-md-10 p-b-30 centered">
        <form class="leave-comment" action="<?= base_url('keranjang/checkout'); ?>" method="post">
            ...
            <div>
                <input type="hidden" id="nama" name="id_transaksi" placeholder="Kode Transaksi" value="<?= $kode_transaksi ?>" readonly required>
            </div>
            ...
            <div class="w-size25">
                <!-- Button -->
                <button class="flex-c-m size2 bg1 bo-rad-23 hov1 m-text3 trans-0-4" type="submit" value="submit" class="btn submit_btn">Checkout
                </button>
            </div>
        </form>
    </div>
